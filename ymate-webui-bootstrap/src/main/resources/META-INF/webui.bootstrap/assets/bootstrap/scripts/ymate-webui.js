...
;$(function () {
     ...
     */
    function __utcToString(timestamp, format) {
        if (!timestamp) {
            return '';
        }
        if (!format) {
        ...
        return __dateFormat(new Date(parseInt(timestamp)), format);
    }
    ...
    window.DateUtils = {
        stringToUTC: __stringToUTC,
        utcToString: __utcToString,
