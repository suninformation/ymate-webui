...
<ymweb:ui cleanup="false">
    <ymweb:layout cleanup="false">
        <bs:page title="@{title}" _style="${_bodyStyles}" _class="${_bodyClass}" lang="${_pageLang}" author="${_pageAuthor}" charset="${_pageCharset}" viewport="${_pageViewPort}" keywords="${_pageKeywords}" description="${_pageDescription}">
            <jsp:attribute name="headerBody">
                ...
                <c:if test="${_bootstrapTheme}"><link href="@{page.path}assets/bootstrap/styles/bootstrap-theme.min.css" rel="stylesheet" type="text/css"></c:if>
